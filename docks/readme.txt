...
Letter, G: Seeks forward by 1 second in the playing track, if pressed.
Letter, B: Seeks backward by 1 second in the playing track, if pressed.
Letter, R: Goes to the beginning of a track that is currently being played, if pressed.
...
AltF4, Exit the program, if pressed/held down.
